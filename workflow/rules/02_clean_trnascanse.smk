"""
Converts raw tRNAscan-SE output into a consistent tab-separated table. It applies the configured filters for pseudogenes and undetermined NNN predictions so that downstream steps receive only standardized tRNA records.
"""
rule convert_trnascanse_output_to_tsv:
    ...
    shell:
        ...
        python3 workflow/scripts/preprocessing/convert_trnascanse_output_to_tsv.py \
