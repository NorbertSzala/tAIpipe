...
# Parses raw tRNAscan-SE text output and converts it into a consistent tab-separated format. It validates record structure, standardizes anticodon values, and removes pseudogene or NNN predictions according to command-line options.
