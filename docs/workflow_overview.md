...
* **Rule Module Location:** `workflow/rules/01_run_trnascanse.smk`
...
* **Module:** `workflow/rules/02_clean_trnascanse.smk`
...
* **Module:** `workflow/rules/03_build_trna_profile.smk`
...
* **Rule Module Location:** `workflow/rules/07_compute_codon_metrics.smk`
