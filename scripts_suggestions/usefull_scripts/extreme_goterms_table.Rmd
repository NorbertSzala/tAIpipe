...
# 	- najpierw bezwzględne zliczenia a potem enrichment. Enrichment policzyłem: (liczba wystąpień domen PFAM = PF00004 w zbiorze extremum/ liczba wszystkich domen w zbiorze extremum hi lub lo)/ (liczba wystąpień domen PFAM = PF00004 w ogólnym zbiorze) /liczba wszystkich domen w zbiorze ogólnym
# 	# 	
